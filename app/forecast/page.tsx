    ...
    <div className="space-y-4">
      <div className="page-heading">
        ...
        <div className="flex gap-1 text-sm">
          {[0, 1, 2].map((w) => (
            <button key={w} aria-pressed={week === w} onClick={() => setWeek(w)} className={`px-3 py-2.5 rounded-xl ${week === w ? "bg-teal-700 text-white dark:bg-teal-400 dark:text-zinc-950" : "hover:bg-zinc-100 dark:hover:bg-zinc-800"}`}>
